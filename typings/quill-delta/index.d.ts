declare module 'quill-delta' {
    ...
    export interface DeltaStatic {
        ...
        transform(index: number, priority?: boolean = false): number
        transform(other: DeltaStatic, priority?: boolean = false): DeltaStatic
        transformPosition(index: number): number
        invert(base: DeltaStatic): DeltaStatic
    }

    export default class Delta implements DeltaStatic {
